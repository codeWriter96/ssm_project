...
<script type="text/javascript">
	...
	$(function () {
		...
		$("#create-Stage").change(function () {
			...
			//转为json对象，直接[xxx]就可以了
			var json =${possibility};
			var res = json[$stage];
	...
	function saveTran() {
		$.ajax({
			...
			data:{
				...
				"customerId":$("#create-customerId").val(),
			...
			success:function (data) {
				if(data.success){
					...
					$.each(data.list,function (i,n) {
						html += '<option value="'+n.id+'" id="'+n.id+'">'+n.name+'</option>'
					})
